...
export default function InventorySessionPage() {
  ...
  const handleSaveCount = () => {
    if (!activeSession || !currentProduct) return;
    
    const partialOz = partialPercent[0] > 0 ? (partialPercent[0] / 100) * (currentProduct.bottleSizeMl || 750) / 29.574 : null;
      ...
      <main className="p-4">
        ...
        {mode === "setup" && (
          <div className="space-y-6">
            ...
            <Button
              ...
              disabled={!selectedZone || startSessionMutation.isPending}
              ...
              <CardContent className="p-0">
                <div className="aspect-[4/3] bg-black flex items-center justify-center">
                  <div className="text-center text-white/60">
                    ...
                    <p>Camera Preview</p>
                    <p className="text-sm">(Simulated - tap product to test)</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        {mode === "input" && currentProduct && (
          <div className="space-y-6">
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-white font-medium">Open Bottle Weight</span>
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
                  ...
                  >
                    ...
                    {scaleWeight !== null ? `${scaleWeight}g` : "Connect Scale"}
                  </Button>
                </div>
            ...
            <Card className="bg-[#0a2419] border-2 border-[#1A4D2E]">
              <CardContent className="p-4">
                <p className="text-white font-medium mb-4">Full Sealed Bottles</p>
            ...
            >
              {saveCountMutation.isPending ? "Saving..." : "Save & Scan Next"}
            </Button>
          </div>
        )}
        ...
        {mode === "review" && (
          <div className="space-y-4 pb-24">
            ...
            {Array.from(counts.entries()).map(([productId, count]) => {
              ...
              const totalCounted = count.countedBottles + (count.countedPartialOz ? count.countedPartialOz / ((product.bottleSizeMl || 750) / 29.574) : 0);
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium text-white">{product.name}</p>
                        <p className="text-sm text-white/60">
                          Expected: {expected.toFixed(1)} | Counted: {totalCounted.toFixed(1)}
                        </p>
                      </div>
